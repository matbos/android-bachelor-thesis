...
/** 
 * DAO for table MEDITATION.
*/
public class MeditationDao extends AbstractDao<Meditation, Void> {

    public static final String TABLENAME = "MEDITATION";

    /**
     * Properties of entity Meditation.<br/>
    ...
    */
    ...
    public MeditationDao(DaoConfig config) {
        super(config);
    }
    
    public MeditationDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MEDITATION' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MEDITATION'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Meditation entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Meditation readEntity(Cursor cursor, int offset) {
        Meditation entity = new Meditation( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Meditation entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(Meditation entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(Meditation entity) {
        return null;
    }
