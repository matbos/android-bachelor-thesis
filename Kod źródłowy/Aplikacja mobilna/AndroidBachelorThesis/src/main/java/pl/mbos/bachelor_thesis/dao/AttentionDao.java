...
*/
public class AttentionDao extends AbstractDao<Attention, Void> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(Attention entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(Attention entity) {
        return null;
    }
