...
/** 
 * DAO for table POOR_SIGNAL.
*/
public class PoorSignalDao extends AbstractDao<PoorSignal, Void> {

    public static final String TABLENAME = "POOR_SIGNAL";

    /**
     * Properties of entity PoorSignal.<br/>
    ...
    */
    ...
    public PoorSignalDao(DaoConfig config) {
        super(config);
    }
    
    public PoorSignalDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'POOR_SIGNAL' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'POOR_SIGNAL'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, PoorSignal entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public PoorSignal readEntity(Cursor cursor, int offset) {
        PoorSignal entity = new PoorSignal( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, PoorSignal entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(PoorSignal entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(PoorSignal entity) {
        return null;
    }
